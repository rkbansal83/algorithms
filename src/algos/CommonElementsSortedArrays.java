...
public class CommonElementsSortedArrays {
	...
	public static void main(String[] args) {
		...
		int[][] arrays = { { 23, 34, 67, 89, 123, 566, 1000 }, {23},{ 11, 22, 23, 24, 33, 37, 185, 566, 987, 1223, 1234 },
		...
		boolean isSmallestArrayFound = false;
		ArrayList<Integer> results = new ArrayList<Integer>();

		for (int i = 0; i < len  && (!isSmallestArrayFound); i++) {
			int totalFound = 0;
			...
			for (int j = 1; j < arrays.length; j++) {
				...
				if(foundIndexes[j - 1]==arrays[j].length - 1)
					isSmallestArrayFound = true;
